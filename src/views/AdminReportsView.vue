    ...
    <div class="flex flex-1 min-h-0 overflow-hidden">
      ...
      <main class="flex-1 min-h-0 py-6 pl-4 pr-4 md:pr-8 overflow-y-auto flex flex-col">
        <div class="w-full flex flex-col flex-1 min-h-0">
          ...
          <!-- Card container -->
          <div class="bg-white rounded-[2rem] border-2 border-slate-300 shadow-sm flex flex-col overflow-hidden flex-1 min-h-0">
            ...
            <!-- ── Table ─────────────────────────────────────────────────── -->
            <div class="flex-1 min-h-0 px-4 sm:px-6 lg:px-10 md:pr-10 pb-4 overflow-x-auto">
