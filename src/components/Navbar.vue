...
<template>
  <nav class="bg-header py-3 sm:py-4 px-4 sm:px-6 md:px-12 shadow-sm">
    <div class="container mx-auto flex flex-col md:flex-row justify-between items-center gap-2 sm:gap-4">
      ...
      <!-- Menu -->
      <div class="flex flex-wrap justify-center items-center gap-1.5 sm:gap-2 md:gap-4 w-full md:w-auto">
        <router-link 
          to="/servicios" 
