            ...
            <form @submit.prevent="submitReport" class="space-y-5" :class="isSubmitting ? 'pointer-events-none select-none opacity-70' : ''">
              ...
              <div class="pt-4 sm:pt-6 flex flex-col items-center gap-4">
                <button 
                  ...
                  class="bg-[#B71C1C] hover:bg-red-800 disabled:bg-slate-400 disabled:hover:bg-slate-400 disabled:opacity-100 disabled:cursor-not-allowed text-white text-xs font-bold px-8 py-3 rounded-xl transition-all w-[240px] tracking-wide flex items-center justify-center font-body min-h-[44px]"
                >
